 ...
 *
 * To see the functional implementation check out src/ngAnimate/animate.controllers
 */
 ...
 * the browser console.
 *
 * In unit tests, if `angular-mocks.controllers` is loaded, this service is overridden by
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
     ...
     * ```html
     * <file src="./test/ng/rootScopeSpec.controllers" tag="docs1" />
     * ```
     *
     * # Inheritance
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$injector', function($injector) {
     ...
     *   resourceUrl, html, controllers and css.
...
function $SceProvider() {
   ...
   * sce.controllers and sceSpecs.controllers would need to be aware of this detail.
   */
  ...
  this.$get = ['$parse', '$sniffer', '$sceDelegate', function(
     ...
     *
     * @param {string} type The kind of context in which this value is safe for use.  e.g. url,
     *   resource_url, html, controllers and css.
     * @param {*} value The value that that should be considered trusted/safe.
     * @returns {*} A value that can be used to stand in for the provided `value` in places
     * where Angular expects a $sce.trustAs() return value.
     */
 ...
 * directive on the root element of the application or on the `angular.controllers` script tag, whichever
